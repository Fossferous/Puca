...
- **RNNoise (ML)** — a small neural model in an audio worklet; better on keyboards, fans and background voices, ~20 ms of delay (992 samples at 48 kHz, `RNNOISE_WORKLET_LATENCY`).
