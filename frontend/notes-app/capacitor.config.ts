 ...
 *     Púca account;
 *   - none of Púca's native plugins (keep-alive, FCM). Its own small ones
 *     live in android/app/src/main/java/com/sovereign/notes (due-reminder
 *     alarms, the hourly refresh, location reminders, share), and every
 *     native dependency is listed in THIS folder's package.json, never in
 *     ../package.json, which would link it into Púca's APK;
