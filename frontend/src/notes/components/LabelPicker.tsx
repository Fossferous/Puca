/**
 * MOVED to components/notes/LabelPicker.tsx — this colour/label chrome is shared
 ...
 * still import './LabelPicker' from inside notes/components/ (a rename on one
 ...
 */
export { LabelPicker } from '../../components/notes/LabelPicker';
